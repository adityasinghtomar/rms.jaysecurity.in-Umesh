                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="info text-sm">
                                    <strong>{{ __('Employee Aadhar no. ') }}</strong>
                                    <span>{{ $employee->aadhar_card_no }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info text-sm">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong>{{ __('UAN Number') }}</strong>
                                    <span>{{ $employee->uan_number }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong>{{ __('PF Number') }}</strong>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    ...
                                    <span>{{ !empty($employee->company) ? $employee->company->name : '' }}</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong>{{ __('Employee Roles') }}</strong>
                        ...
                        <table class="table table-striped mb-0 dataTable" >
                            ...
                            @foreach ($transfers as $transfer)
                                <tr>
                                    ...
                                    <td>{{ !empty($transfer->company())?$transfer->company()->name:'' }}</td>
                                    <td>{{  \Auth::user()->dateFormat($transfer->transfer_date) }}</td>
                                    <td>{{ $transfer->description }}</td>
                                    <td>{{ $transfer->working_day }}</td>
                                                                    </tr>
                            @endforeach
                            </tbody>
                        </table>
