                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card bg-none p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        {{Form::label('day',__('Day Of Joining'),['class'=>'form-control-label text-dark']) }}
                                        {{Form::text('day',null,array('class'=>'form-control'))}}
                                    </div>
                                    
                                    <div class="form-group col-md-6">
                                        {{Form::label('pf',__('PF%'),['class'=>'form-control-label text-dark']) }}
                                        {{Form::text('pf',null,array('class'=>'form-control'))}}
                                    </div>
                                    <div class="col-12 text-right">
