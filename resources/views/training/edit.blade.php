<div class="card bg-none card-box">
    {{Form::model($training,array('route' => array('training.update', $training->id), 'method' => 'PUT','enctype' => 'multipart/form-data')) }}
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-6">
            {{ Form::label('avatar', __('Training Photo'), ['class' => 'form-control-label']) }}
