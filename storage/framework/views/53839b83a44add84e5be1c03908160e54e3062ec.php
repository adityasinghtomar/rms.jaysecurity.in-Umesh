            ...
            <li class="nav-item">
                ...
                <div class="collapse <?php echo e((Request::route()->getName() == 'user.index' || Request::route()->getName() == 'roles.index' || Request::route()->getName() == 'permissions.index' || Request::route()->getName() == 'employee.profile' || Request::route()->getName() == 'lastlogin') ? 'show' : ''); ?>" id="navbar-staff">
                    <ul class="nav flex-column submenu-ul">
                        ...
                        <li class="nav-item">
                        <a href="<?php echo e(route('idcard.index')); ?>" class="nav-link <?php echo e(request()->is('idcard*') ? 'active' : ''); ?>">
                            <?php echo e(__('Id Card')); ?>
        ...
        <?php else: ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Transfer')): ?>
                        <li class="nav-item <?php echo e(request()->is('transfer*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('transfer.index')); ?>" class="nav-link"><i class="fas fa-users"></i><?php echo e(__('Employee Transfer ')); ?></a>
                        </li>
                    <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Employee Field')): ?>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('salary.index')); ?>" class="nav-link  <?php echo e((Request::route()->getName() == 'salary.index') ||  (Request::route()->getName() == 'salary.create') ||  (Request::route()->getName() == 'salary.edit')  ? 'active' : ''); ?>">
                    <i class="fas fa-users"></i><?php echo e(__('Company Wise Salary ')); ?>
    ...
    <?php endif; ?>
        ...
        <li class="nav-item <?php echo e(request()->is('company*') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('branch.index')); ?>">
                <i class="fa fa-map"></i><?php echo e(__('Location')); ?></a>
        </li>
        <?php endif; ?>
     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Role')): ?>
        <li class="nav-item <?php echo e(request()->is('emp-role*') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('emp-role.index')); ?>">
                <i class="fas fa-users"></i><?php echo e(__('Employee Role')); ?></a>
        </li>
        <?php endif; ?>
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Company')): ?>
        <li class="nav-item <?php echo e(request()->is('company*') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('company.index')); ?>">
                <i class="fa fa-building"></i></i><?php echo e(__('Company')); ?></a>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item <?php echo e(request()->is('company-unit*') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('company-unit.index')); ?>">
                <i class="fas fa-user-cog"></i><?php echo e(__('Company Unit')); ?></a>
        </li>
        <?php endif; ?>
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Department')): ?>
        <li class="nav-item <?php echo e(request()->is('department*') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('department.index')); ?>">
                <i class="fas fa-building"></i><?php echo e(__('Department')); ?></a>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item <?php echo e(request()->is('designation*') ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('designation.index')); ?>">
                <i class="fas fa-users"></i><?php echo e(__('Designation')); ?></a>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e((Request::route()->getName() == 'setsalary.index' || Request::route()->getName() == 'setsalary.show' ||  Request::route()->getName() == 'payslip.index' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'setsalary.edit' || Request::route()->getName() == 'employeesalary' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'payslip.pdf') ? 'active' : 'collapsed'); ?>"
               ...
               ()->getName() == 'payslip.pdf') ? 'true' : 'false'); ?>" aria-controls="navbar-payroll">
                <i class="fas fa-receipt"></i><?php echo e(__('Selary')); ?>
            ...
            <div class="collapse <?php echo e((Request::route()->getName() == 'setsalary.index' || Request::route()->getName() == 'setsalary.show' ||  Request::route()->getName() == 'payslip.index' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'setsalary.edit' || Request::route()->getName() == 'employeesalary' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'payslip.pdf') ? 'show' : ''); ?>"
                ...
                <ul class="nav flex-column submenu-ul">
                    ...
                    <li class="nav-item <?php echo e(request()->is('setsalary*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('emp_salary.index')); ?>" class="nav-link"><?php echo e(__('Salary')); ?></a>
                    </li>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Attendance')): ?>
                        <li class="nav-item submenu-li">
                            ...
                            <div class="collapse submenu-ul <?php echo e((Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance') ? 'show' : ''); ?>" id="navbar-attendance">
                                ...
                                <li class="nav-item">
                                  <a href="<?php echo e(route('graph.index')); ?>" class="nav-link <?php echo e(request()->is('graph*') ? 'active' : ''); ?>">
                                <?php echo e(__('Graph')); ?>
...
<?php /**PATH /home/progressiveaidat/public_html/rms/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>