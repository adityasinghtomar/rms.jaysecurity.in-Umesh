...
<div class="container-main" style=" margin-bottom: 26px; margin-top: 15px;height:215px;width: 736px;margin-left: 64px;"> 
     ...
     <div class="container" style="border: 2px solid black;font-size: 10px;height:229.98px; width:366px;margin-left:42px; position:relative;  ">

               <a href="#" onclick="window.print();" target="_blank"></a>

           <h3 style="font-family: 'Inter', sans-serif;  margin-top: 12px;font-size: 17px;color: red; text-align: center;"> <img src="<?php echo e(url('public/uploads/logo/logo1.png')); ?>" width="30px" height="25px">  <b>JAY SECURITY SERVICES</b></h3>
          ...
          <img style="width: 76px; margin: -12px 0; position:absolute; top:55%; left:8px;" src="<?php echo e(url('public/uploads/')); ?>/<?php echo e($photo); ?>" />
          ...
          <ul style="margin-left: 54px;font-size: 13px;margin-top: -13%;"></br>
              ...
              <b> Name Of Emp : <?php echo e($employee->name); ?></b>

              </li>

              <li style="list-style: none; font-weight: 50 font-family: 'Noto Sans TC', sans-serif;">

              <b>Emp. Code No : <?php echo e($employee->employee_id); ?></b>
              ...
              <b>Date of Birth : <?php echo e($employee->dob); ?></b>
    ...
    <div class="container1" style="position: relative;bottom: 229px;border: 2px solid black;font-size: 11px;margin-left:412px; height: 229.98px;width: 366px;padding: 29px;">
        ...
        <ol style="position: relative; bottom:36px; font-size:11px;">
            ...
            <b><p style="margin-top: -9px;margin-left: -12px;">Address : <?php echo e($field_value); ?>,<?php echo e($dist); ?>,<?php echo e($localstate1); ?>,<?php echo e($local_pin1); ?></p></b>
...
<?php /**PATH /home3/jaysecurity/sms.jaysecurity.in/resources/views/employee/idcard.blade.php ENDPATH**/ ?>