                        ...
                        <table class="table table-striped mb dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('Date Of Exit')); ?></th>
                                    <th><?php echo e(__('Id Card')); ?></th>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($employee->company_doj); ?></td>
                                        <td><?php echo e($employee->status); ?></td>
                                        <td><?php echo e($employee->date_of_exit); ?></td>
                                        <td>
                                              <a href="<?php echo e(route('employee.idcard',($employee->id))); ?>">Print</a>
                                        </td>
                                        <?php if(Gate::check('Edit Employee') || Gate::check('Delete Employee')): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/progressiveaidat/public_html/rms/resources/views/employee/index.blade.php ENDPATH**/ ?>