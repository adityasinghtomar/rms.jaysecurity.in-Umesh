                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="info text-sm">
                                    <strong><?php echo e(__('Employee Aadhar no. ')); ?></strong>
                                    <span><?php echo e($employee->aadhar_card_no); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info text-sm">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm font-style">
                                    <strong><?php echo e(__('Father Name')); ?></strong>
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong><?php echo e(__('UAN Number')); ?></strong>
                                    <span><?php echo e($employee->uan_number); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong><?php echo e(__('PF Number')); ?></strong>
                                    <span><?php echo e($employee->pf_number); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    ...
                                    <span><?php echo e(!empty($employee->company) ? $employee->company->name : ''); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong><?php echo e(__('Employee Roles')); ?></strong>
                                    <span><?php echo e($employee->emp_name); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info text-sm">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/progressiveaidat/public_html/rms/resources/views/employee/show.blade.php ENDPATH**/ ?>