<div class="card bg-none card-box">
    <?php echo e(Form::model($training,array('route' => array('training.update', $training->id), 'method' => 'PUT','enctype' => 'multipart/form-data'))); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <?php echo e(Form::label('avatar', __('Training Photo'), ['class' => 'form-control-label'])); ?>
...
<?php /**PATH /home/progressiveaidat/public_html/rms/resources/views/training/edit.blade.php ENDPATH**/ ?>