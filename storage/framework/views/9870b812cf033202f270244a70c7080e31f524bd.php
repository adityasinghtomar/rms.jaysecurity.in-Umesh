            ...
            <ul class="navbar-nav ml-lg-auto align-items-lg-center">
                <?php if(Auth::user()->type != 'super admin'): ?>
                    ...
                    <?php if(Auth::user()->type == 'Supervisor'): ?>
                        ...
                        <!-- user notification -->
                        <?php $employees = notification(); ?>
                        
                        <li class="nav-item dropdown dropdown-animate ">
                            <a class="nav-link nav-link-icon" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-bell m-0"></i>
                                <span class="badge badge-danger badge-circle badge-btn custom_messanger_counter">
                                    <?php if(isset($employees)): ?> <?php echo e(!empty($employees) ? $employees->count() : 0); ?>  <?php endif; ?>
                                </span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg dropdown-menu-arrow p-0">
                                <div class="py-3 px-3">
                                    <h5 class="heading h6 mb-0"><?php echo e(__('Notifications')); ?></h5>
                                </div>
                                <div class="list-group list-group-flush dropdown-list-message-msg p-3">
                                    <ul style="color:red; padding:10px;">
                                        <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <li class="m-0"> <?php echo e($employee->employee_id); ?> - <?php echo e($employee->note); ?> </li>
...
<?php /**PATH /home/progressiveaidat/public_html/rms/resources/views/partial/Admin/header.blade.php ENDPATH**/ ?>